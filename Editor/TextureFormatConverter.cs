...
public class TextureFormatConverter : EditorWindow
{
    ...
    {
        var window = GetWindow<TextureFormatConverter>("Texture Format Converter");
        window.minSize = new Vector2(600, 760);
    }

    private void OnGUI()
    {
        GUILayout.Label("Texture Format Converter", EditorStyles.boldLabel);
    ...
    private void AddTextureFromObject(Object obj)
    {
        ...
        else
        {
            ...
            {
                var tex2 = AssetDatabase.LoadAssetAtPath<Texture2D>(dep);
